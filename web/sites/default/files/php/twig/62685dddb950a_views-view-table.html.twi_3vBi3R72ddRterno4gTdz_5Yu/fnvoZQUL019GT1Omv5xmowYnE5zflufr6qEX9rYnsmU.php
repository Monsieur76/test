...
class __TwigTemplate_55888367bff366803c54d37372c42a0a874a5ab3007eda0060237ceb18fc6897 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 35
        $context["classes"] = [0 => "table", 1 => ("cols-" . twig_length_filter($this->env, $this->sandbox->ensureToStringAllowed(        // line 37
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["key"] => $context["column"]) {
                ...
                if (twig_get_attribute($this->env, $this->source, $context["column"], "default_classes", [], "any", false, false, true, 59)) {
                    ...
                    echo "            ";
                    // line 61
                    $context["column_classes"] = [0 => "views-field", 1 => ("views-field-" . $this->sandbox->ensureToStringAllowed((($__internal_compile_0 =                     // line 63
($context["fields"] ?? null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0[$context["key"]] ?? null) : null), 63, $this->source))];
                ...
                // line 67
                echo "          <th";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["column"], "attributes", [], "any", false, false, true, 67), "addClass", [0 => ($context["column_classes"] ?? null)], "method", false, false, true, 67), "setAttribute", [0 => "scope", 1 => "col"], "method", false, false, true, 67), 67, $this->source), "html", null, true);
                echo ">";
                // line 68
            ...
            foreach ($context['_seq'] as $context["key"] => $context["column"]) {
                ...
                if (twig_get_attribute($this->env, $this->source, $context["column"], "default_classes", [], "any", false, false, true, 92)) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                        // line 99
                        echo "              ";
                        $context["column_classes"] = twig_array_merge($this->sandbox->ensureToStringAllowed(($context["column_classes"] ?? null), 99, $this->source), [0 => ("views-field-" . $this->sandbox->ensureToStringAllowed($context["field"], 99, $this->source))]);
                        // line 100
                        echo "            ";
                    }
                    $_parent = $context['_parent'];
                ...
                // line 102
                echo "          <td";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["column"], "attributes", [], "any", false, false, true, 102), "addClass", [0 => ($context["column_classes"] ?? null)], "method", false, false, true, 102), 102, $this->source), "html", null, true);
                echo ">";
                // line 103
...
";
    ...
    {
        return new Source("", "themes/contrib/belgrade/templates/views/views-view-table.html.twig", "C:\\wamp64\\www\\commerce-kickstart-project\\web\\themes\\contrib\\belgrade\\templates\\views\\views-view-table.html.twig");
    }
