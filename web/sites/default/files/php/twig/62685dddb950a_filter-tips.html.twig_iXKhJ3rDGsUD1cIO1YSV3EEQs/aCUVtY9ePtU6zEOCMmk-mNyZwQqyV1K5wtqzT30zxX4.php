...
class __TwigTemplate_f160bd2fa7bca1b51c9fcfb5b28b7e604cebf7f0042787dfbeff4ed0f34de7ab extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/claro/templates/filter/filter-tips.html.twig", "C:\\wamp64\\www\\commerce-kickstart-project\\web\\core\\themes\\claro\\templates\\filter\\filter-tips.html.twig");
    }
